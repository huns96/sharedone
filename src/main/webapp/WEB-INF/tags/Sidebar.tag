...
<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <li class="w-100">
                <a href="#" class="nav-link"> <span class="d-none d-sm-inline" style="align-items: center; color: aliceblue;">판매가</span></a>
            </li>

            <li>
                <a href="#" class="nav-link px-0 align-middle">
                    <i class="fs-4 bi-people"></i> <span class="ms d-none d-sm-inline" style="color: red; font-size: 20px;">영업관리</span> </a>
            </li>
            <li class="w-100">
                <a href="#" class="nav-link"> <span class="d-none d-sm-inline name" style="align-items: center; color: aliceblue;">주문</span></a>
            </li>
            <li class="w-100">
