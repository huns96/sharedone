...
<script>
    function searchOrderCode() {
        console.log("jsp 서치오더코드")
            ...
            const data = document.querySelector("#orderCodeInput").value;
        ...
        // console.log(data) 인풋데이터 받아짐
            fetch("${pageContext.request.contextPath}/report/search/order_code", {
                ...
                .then(res => res.json())
                .then(function (ress){console.log(ress+"ressssss")})
                // .then(function(변수2){document.querySelector('article')
                //     .innerHTML=변수2; })
        console.log("서치코드 jsp 3333333333333334444444444444444444444443333333")
        <%--fetch('${pageContext.request.contextPath}/host/listing/topic/cultrue_society_science')
        .then(function(변수)
        변수.text()
        .then(function(변수2){document.querySelector('article')
        .innerHTML=변수2; }) })--%>
