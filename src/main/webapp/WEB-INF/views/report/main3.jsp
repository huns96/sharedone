    ...
    <div class="row">
        <div class="col">
            ...
            <form action="">
                주문일<input type="date">
                <input type="date">
                주문 코드 : <button id="order_code_search_open">주문코드 검색</button>
...
<script>
    ...
    // const openButton = document.getElementById("order_code_search_open");
    const openModal=()=>{
        document.querySelector("modal").classList.remove("hidden")
    }
    document.getElementById("order_code_search_open").addEventListener("click",openModal);
