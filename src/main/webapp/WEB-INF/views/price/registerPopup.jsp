...
<form class="registerForm" id="registerForm" action="${pageContext.request.contextPath}/price/register" method="post" enctype="multipart/form-data" style="margin: auto;  height: 664px;" >
