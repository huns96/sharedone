              ...
              <div style="margin: 20px;">
                <div class="mb-3 mx-4">
                  <div>
                    ...
                    <input class="form-control" type="text" name="buyer_code" placeholder="바이어 코드" data-bs-toggle="modal" data-bs-target="#buyerModal" style="text-align: center">
                  </div>
                </div>
                <div class="mb-3 mx-4">
                  <label class="form-label">제품코드</label>
                  <input class="form-control" type="text" name="product_code" data-bs-toggle="modal" data-bs-target="#productModal" placeholder="제품 코드" style="text-align: center">
                </div>
                <div class="mb-3 mx-4">
                  <label class="form-label">판매가</label>
                  <input class="form-control" type="int" name="price" style="text-align: center" placeholder="-">
                </div>
                <div class="mb-3 mx-4">
                  <label class="form-label">시작일</label>
                  <input class="form-control" type="date" name="start_date" style="text-align: center">
                </div>
                <div class="mb-3 mx-4">
                  <label class="form-label">종료일</label>
                  <input class="form-control" type="date" name="end_date" style="text-align: center">
                </div>
                <div class="mb-3 mx-4">
