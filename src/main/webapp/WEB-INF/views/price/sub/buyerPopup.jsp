        ...
        <div class="col-3">
            <nav aria-label="Page navigation example">
                <ul class="pagination pagination-sm">
                    <li class="page-item">
                        <c:url value="/price/sub/buyerPopup" var="pageLink">
...
<script type="text/javascript">
    $(function() {
        $('#buyer-table tr').dblclick(function() {
            let tr = $(this);
            let td = tr.children();
            let buyerCode = td.eq(0).text();
            let buyerName = td.eq(1).text();
            opener.$('#buyerCodeInput').val(buyerCode);
            opener.$("[name='buyer_code']").val(buyerCode);
            opener.$('#buyerNameInput').val(buyerName);
            opener.$("[name='buyer_name']").val(buyerName);
